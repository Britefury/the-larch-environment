...
public abstract class Container extends Widget {
	protected class ChildEntry
	{
		...
		public ChildEntry(Widget child)
		{
			this.child = child;
	...
	protected HashMap<Widget, ChildEntry> childToEntry;
	...
	public Container(Color backgroundColour)
	{
		childEntries = new Vector<ChildEntry>();
		childToEntry = new HashMap<Widget, ChildEntry>();
	...
	public Xform2 getChildTransformRelativeToAncestor(Widget child, Widget ancestor, Xform2 x)
	{
	...
	public Point2 getChildLocalPointRelativeToAncestor(Widget child, Widget ancestor, Point2 p)
	{
		ChildEntry entry = childToEntry.get( child );
	...
	protected abstract void removeChild(Widget child);
	...
	protected void onLeaveIntoChild(PointerMotionEvent event, Widget child)
	{
	}
	
	protected void onEnterFromChild(PointerMotionEvent event, Widget child)
	{
	}
	...
	protected void childResizeRequest(Widget child)
	{
	...
	protected void allocateChildX(Widget child, double localPosX, double localWidth)
	{
	...
	protected void allocateChildY(Widget child, double localPosY, double localHeight)
	{
	...
	protected void childRedrawRequest(Widget child, Point2 childPos, Vector2 childSize)
	{
		ChildEntry entry = childToEntry.get( child );
