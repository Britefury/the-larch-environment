...
public class InfixRightLevel extends BinaryOperatorLevel
{
	protected static class InfixRightOperatorResultBuilder
	{
		...
		private int leftPos;
		private Object left, opValue;
		
		public InfixRightOperatorResultBuilder(BinaryOperatorParseAction action, int leftPos, Object left, Object opValue)
		{
			this.action = action;
	...
	private static class InfixRightOpAction implements ParseAction
	{
		...
		public Object invoke(Object input, int begin, int end, Object x, Map<String, Object> bindings)
		{
			...
			Object opValue = xs.get(1);
			return new InfixRightOperatorResultBuilder( action, begin, left, opValue );
		}
	}
