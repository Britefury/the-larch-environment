...
{
	public static final InheritedAttributeNonNull buttonBorder = new InheritedAttributeNonNull( "controls", "buttonBorder", AbstractBorder.class,
			new SolidBorder( 1.0, 3.0, 10.0, 10.0, new Color( 0.55f, 0.525f, 0.5f ), new Color( 0.85f, 0.85f, 0.85f ) ) );
	public static final InheritedAttributeNonNull buttonHighlightBorder = new InheritedAttributeNonNull( "controls", "buttonBorder", AbstractBorder.class,
	...
	public static final InheritedAttributeNonNull checkboxCheckBorder = new InheritedAttributeNonNull( "controls", "checkboxCheckBorder", AbstractBorder.class,
	...
	public static final InheritedAttributeNonNull optionMenuBorder = new InheritedAttributeNonNull( "controls", "optionMenuBorder", AbstractBorder.class,
			new SolidBorder( 1.0, 3.0, 5.0, 5.0, Color.BLACK, new Color( 0.9f, 0.95f, 0.9f ) ) );
	public static final InheritedAttributeNonNull optionMenuHoverBorder = new InheritedAttributeNonNull( "controls", "optionMenuHoverBorder", AbstractBorder.class,
	...
	public static final InheritedAttributeNonNull textEntryBorder = new InheritedAttributeNonNull( "controls", "textEntryBorder", AbstractBorder.class,
			new SolidBorder( 1.0, 3.0, 5.0, 5.0, new Color( 0.0f, 0.3f, 0.0f ), new Color( 0.9f, 0.95f, 0.9f ) ) );
	public static final InheritedAttributeNonNull textEntryInvalidBorder = new InheritedAttributeNonNull( "controls", "textEntryInvalidBorder", AbstractBorder.class,
	...
	public static final InheritedAttributeNonNull tooltipBorder = new InheritedAttributeNonNull( "controls", "tooltipBorder", AbstractBorder.class,
