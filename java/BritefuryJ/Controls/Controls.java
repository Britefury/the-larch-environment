...
public class Controls
{
	...
	public static final InheritedAttributeNonNull hyperlinkAttrs = new InheritedAttributeNonNull( controlsNamespace, "hyperlinkAttrs", StyleSheet.class,
			StyleSheet.instance.withAttr( Primitive.editable, false ).withAttr( Primitive.fontUnderline, true ).withAttr( Primitive.foreground, Color.blue )
	...
	protected static DerivedValueTable<StyleSheet> scrollBarArrowStyle = new DerivedValueTable<StyleSheet>( controlsNamespace )
	{
		protected StyleSheet evaluate(AttributeTable attribs)
		{
