...
public class GSymDefaultPerspective implements GSymPerspective
{
	...
	private ObjectPresenter getPresenterForJavaObject(Object x)
	{
		...
		for (Class<?> interfaceClass: xClass.getInterfaces())
		{
			presenter = objectPresenters.get( interfaceClass );
			if ( presenter != null )
			{
				// Yes - cache it for future tests
				objectPresenters.put( xClass, presenter );
	...
	{
		ObjectPresenter presenter_Character = new ObjectPresenter()
		{
		...
		ObjectPresenter presenter_String = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_Byte = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_Short = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_Integer = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_Long = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_Float = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_Double = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_Boolean = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_PyString = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_PyUnicode = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_PyInteger = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_PyLong = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_PyFloat = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		ObjectPresenter presenter_PyBoolean = new ObjectPresenter()
		{
			public DPElement presentObject(Object x, GSymFragmentViewContext ctx, StyleSheet styleSheet, AttributeTable state)
			{
		...
		registerObjectPresenter( Character.class, presenter_Character );
		registerObjectPresenter( String.class, presenter_String );
		registerObjectPresenter( Integer.class, presenter_Integer );
		registerObjectPresenter( Short.class, presenter_Short );
		registerObjectPresenter( Long.class, presenter_Long );
		registerObjectPresenter( Byte.class, presenter_Byte );
		registerObjectPresenter( Float.class, presenter_Float );
		registerObjectPresenter( Double.class, presenter_Double );
		registerObjectPresenter( Boolean.class, presenter_Boolean );

		registerObjectPresenter( PyString.class, presenter_PyString );
		registerObjectPresenter( PyUnicode.class, presenter_PyUnicode );
		registerObjectPresenter( PyInteger.class, presenter_PyInteger );
		registerObjectPresenter( PyLong.class, presenter_PyLong );
		registerObjectPresenter( PyFloat.class, presenter_PyFloat );
		registerObjectPresenter( PyBoolean.class, presenter_PyBoolean );
	}
