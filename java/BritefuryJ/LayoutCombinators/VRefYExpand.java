...
public class VRefYExpand extends Alignment
{
	public VRefYExpand(Object child)
	{
		super( child );
	}
	...
	{
		return presentChild( child, fragment, styleSheet, inheritedState ).alignVRefYExpand();
	}
}
