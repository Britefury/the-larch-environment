...
import BritefuryJ.DocPresent.Layout.FlowGridLayout;
...
public class LayoutNodeFlowGrid extends ArrangedSequenceLayoutNode
{
	...
	public LayoutNodeFlowGrid(DPContainer element)
	{
		super( element );
		rowReqBoxes = null;
		rowAllocBoxes = null;
	...
	protected DPElement getChildLeafClosestToLocalPoint(Point2 localPos, ElementFilter filter)
	{
		...
		if ( columnBounds != null  &&  cellPos != null )
		{
			...
			DPElement child = leaves[childIndex];
	...
	{
		return ((DPFlowGrid)element).getTargetNumColumns();
	}
}
