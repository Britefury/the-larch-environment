...
public class DndInteractor
{
	private PointerDndController dndController;
	private PointerInputElement rootElement;
	private DndDropLocal dndDrop;
	
	
	public DndInteractor(PointerInputElement rootElement, PointerDndController dndController)
	{
	...
	protected void buttonDown(PointerButtonEvent event)
	{
		dndButtonDownEvent( event );
	}

	protected boolean buttonUp(PointerButtonEvent event)
	{
		return dndButtonUpEvent( event );
	}

	protected boolean drag(PointerMotionEvent event, MouseEvent mouseEvent)
	{
