...
import BritefuryJ.DocPresent.LayoutTree.LayoutNodeFlowGrid;
import BritefuryJ.DocPresent.StyleParams.TableStyleParams;
import BritefuryJ.Math.Point2;


public class DPFlowGrid extends DPContainerSequence implements TableElement
{
	...
	public DPFlowGrid(TableStyleParams styleParams)
	{
		this( styleParams, -1 );
	}
	
	public DPFlowGrid(TableStyleParams styleParams, int targetNumColumns)
	{
		super(styleParams);
