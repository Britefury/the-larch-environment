...
class CVTNegate (CVTExpression):
	graphNode = SheetRefField( CGNegate )


	exprNode = CVTSimpleSinkProductionSingleField( CGNegate.expr )





	def unwrapNegate(self):
...
class CVTRuleNegate (CVTRuleSimple):
	graphNodeClass = CGNegate
	cvtNodeClass = CVTNegate

CVTRuleNegate.register()
