...
class Python25Grammar (Grammar):
	...
	def asciiStringSLiteral(self):
		return singleQuotedString.action( lambda input, pos, xs: [ 'stringLiteral', 'ascii', 'single', xs[1:-1] ] )
	
	@Rule
	def asciiStringDLiteral(self):
		return doubleQuotedString.action( lambda input, pos, xs: [ 'stringLiteral', 'ascii', 'double', xs[1:-1] ] )
	
	@Rule
	def unicodeStringSLiteral(self):
		return ( Suppress( Literal( 'u' )  |  Literal( 'U' ) ) + singleQuotedString ).action( lambda input, pos, xs: [ 'stringLiteral', 'unicode', 'single', xs[0][1:-1] ] )
	
	@Rule
	def unicodeStringDLiteral(self):
		return ( Suppress( Literal( 'u' )  |  Literal( 'U' ) ) + doubleQuotedString ).action( lambda input, pos, xs: [ 'stringLiteral', 'unicode', 'double', xs[0][1:-1] ] )
	
	@Rule
	def regexAsciiStringSLiteral(self):
		return ( Suppress( Literal( 'r' )  |  Literal( 'R' ) ) + singleQuotedString ).action( lambda input, pos, xs: [ 'stringLiteral', 'ascii-regex', 'single', xs[0][1:-1] ] )
	
	@Rule
	def regexAsciiStringDLiteral(self):
		return ( Suppress( Literal( 'r' )  |  Literal( 'R' ) ) + doubleQuotedString ).action( lambda input, pos, xs: [ 'stringLiteral', 'ascii-regex', 'double', xs[0][1:-1] ] )
	
	@Rule
	def regexUnicodeStringSLiteral(sefl):
		return ( Suppress( Literal( 'ur' )  |  Literal( 'uR' )  |  Literal( 'Ur' )  |  Literal( 'UR' ) ) + singleQuotedString ).action( lambda input, pos, xs: [ 'stringLiteral', 'unicode-regex', 'single', xs[0][1:-1] ] )
	
	@Rule
	def regexUnicodeStringDLiteral(self):
		return ( Suppress( Literal( 'ur' )  |  Literal( 'uR' )  |  Literal( 'Ur' )  |  Literal( 'UR' ) ) + doubleQuotedString ).action( lambda input, pos, xs: [ 'stringLiteral', 'unicode-regex', 'double', xs[0][1:-1] ] )
	...
	def decimalIntLiteral(self):
		return decimalInteger.action( lambda input, pos, xs: [ 'intLiteral', 'decimal', 'int', xs ] )
	
	@Rule
	def decimalLongLiteral(self):
		return ( decimalInteger + Suppress( Literal( 'l' )  |  Literal( 'L' ) ) ).action( lambda input, pos, xs: [ 'intLiteral', 'decimal', 'long', xs[0] ] )
	
	@Rule
	def hexIntLiteral(self):
		return hexInteger.action( lambda input, pos, xs: [ 'intLiteral', 'hex', 'int', xs ] )
	
	@Rule
	def hexLongLiteral(self):
		return ( hexInteger + Suppress( Literal( 'l' )  |  Literal( 'L' ) ) ).action( lambda input, pos, xs: [ 'intLiteral', 'hex', 'long', xs[0] ] )
	...
	def floatLiteral(self):
		return floatingPoint.action( lambda input, pos, xs: [ 'floatLiteral', xs ] )
	...
	def imaginaryLiteral(self):
		return Combine( [ ( floatingPoint | decimalInteger ), Literal( 'j' ) ] ).action( lambda input, pos, xs: [ 'imaginaryLiteral', xs ] )
...
class TestCase_Python25Parser (ParserTestCase):
	def test_shortStringLiteral(self):
		g = Python25Grammar()
		self._matchTest( g.expression(), '\'abc\'', [ 'stringLiteral', 'ascii', 'single', 'abc' ] )
		self._matchTest( g.expression(), '\"abc\"', [ 'stringLiteral', 'ascii', 'double', 'abc' ] )
		self._matchTest( g.expression(), 'u\'abc\'', [ 'stringLiteral', 'unicode', 'single', 'abc' ] )
		self._matchTest( g.expression(), 'u\"abc\"', [ 'stringLiteral', 'unicode', 'double', 'abc' ] )
		self._matchTest( g.expression(), 'r\'abc\'', [ 'stringLiteral', 'ascii-regex', 'single', 'abc' ] )
		self._matchTest( g.expression(), 'r\"abc\"', [ 'stringLiteral', 'ascii-regex', 'double', 'abc' ] )
		self._matchTest( g.expression(), 'ur\'abc\'', [ 'stringLiteral', 'unicode-regex', 'single', 'abc' ] )
		self._matchTest( g.expression(), 'ur\"abc\"', [ 'stringLiteral', 'unicode-regex', 'double', 'abc' ] )
		
		
	def test_integerLiteral(self):
		g = Python25Grammar()
		self._matchTest( g.expression(), '123', [ 'intLiteral', 'decimal', 'int', '123' ] )
		self._matchTest( g.expression(), '123L', [ 'intLiteral', 'decimal', 'long', '123' ] )
		self._matchTest( g.expression(), '0x123', [ 'intLiteral', 'hex', 'int', '0x123' ] )
		self._matchTest( g.expression(), '0x123L', [ 'intLiteral', 'hex', 'long', '0x123' ] )
	
		
	def test_floatLiteral(self):
		g = Python25Grammar()
		self._matchTest( g.expression(), '123.0', [ 'floatLiteral', '123.0' ] )
	
		
	def test_imaginaryLiteral(self):
		g = Python25Grammar()
		self._matchTest( g.expression(), '123.0j', [ 'imaginaryLiteral', '123.0j' ] )
