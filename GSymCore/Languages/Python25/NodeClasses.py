...
# Mathematical / bitwise / comparison / test operators
...
Lte = module.newClass( 'Lte', Expr, [ 'x', 'y' ] )
Lt = module.newClass( 'Lt ', Expr, [ 'x', 'y' ] )
Gte = module.newClass( 'Gte', Expr, [ 'x', 'y' ] )
Gt = module.newClass( 'Gt', Expr, [ 'x', 'y' ] )
Eq = module.newClass( 'Eq', Expr, [ 'x', 'y' ] )
Neq = module.newClass( 'Neq', Expr, [ 'x', 'y' ] )
